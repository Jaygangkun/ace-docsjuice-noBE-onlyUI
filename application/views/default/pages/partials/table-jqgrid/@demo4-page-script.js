jQuery(function($) {
	...
	$(grid_selector).jqGrid({
		...
		colModel:[
			...
			{resizable: false,name:'unitprice',index:'unitprice', width:30,editable: true,editoptions:{size:"20",maxlength:"30"}},
			{resizable: false,name:'qty',index:'qty', width:30, editable: true,editoptions: {size:"20",maxlength:"30"}},
			{resizable: false,name:'totalprice',index:'totalprice', width:30,editable: true,editoptions:{size:"20",maxlength:"30"}}
		],
